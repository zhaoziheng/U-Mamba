...
def evaluate(dataset):
    ...
    with open(join('/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/{}/dataset.json'.format(dataset)), 'r') as f:
        tmp = json.load(f)
        modality = tmp["channel_names"]['0']
    
    save_path = '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/{}/labelsPred_UMambaBot'.format(dataset)
    os.makedirs(save_path, exist_ok=True)

    seg_path = join('/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/{}/labelsPred_UMambaBot'.format(dataset))
    gt_path = join('/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/{}/labelsTs'.format(dataset))
    csv_path = '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/{}/labelsPred_UMambaBot/{}_results.csv'.format(dataset, dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='Dataset016_BTCV')
